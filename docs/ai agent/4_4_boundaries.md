...
### Reason codes
Each proposal has reason codes, list of assumptions, and risk factors.

### Decision log
What, when, and on what basis was suggested – available to users.

### User control
<mark>Users can disable personalization</mark> or reset their profile.
